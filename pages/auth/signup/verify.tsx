            ...
            <div className={'flex justify-center justify-items-center p-1 md:py-12'}>
                <div className={'w-full md:w-1/3 text-xs'}>
                    ...
                    <p className={'text-left mb-6'}>
                        We have sent a message to sympah@aol.com with a link to activate your accont
                    </p>
                    <div>
                        ...
                        <p className={'mb-6'}>
                        If you don’t see an email from us within the next few minutes, a few thungs could have happened
                    </p>
                        <ul className={'px-6'}>
