...
function installGoogleAuthPlugin(options) {
    //set config
    ...
    //Install Vue plugin
    window.$gAuth = googleAuth();
    window.$gAuth.prompt = prompt;
    window.$gAuth.GoogleAuthConfig = GoogleAuthConfig;
}


installGoogleAuthPlugin({clientId: "967504610977-0f2sg2eiflpu0k92hve1aqu1gpel3p0a.apps.googleusercontent.com"})
